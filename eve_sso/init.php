...
class EVE_SSO
{
  ...
  function kill_detail(&$object)
  {
    ...
    if(isset($_POST['eve_sso']))
    {
      ...
      $_SESSION['sso_post_url'] = edkURI::page('sso_post');
      $sso_url = "https://sisilogin.testeveonline.com/oauth/authorize/?response_type=code&redirect_uri=http://dontshootx.com/killboard/%3Fa%3Dsso_post&client_id=".config::get('eve_sso_client_id')."&scope=&state=".$_SESSION['state_val'];
